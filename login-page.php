                    ...
                    <div class="login-inner-form">
                        <form action="login-page-data.php" method="post">
                            <div class="form-group clearfix">
                                ...
                                <div class="form-box">
                                    <input type="email" class="form-control" id="first_field" name="TxtEmail" placeholder="Email Address" aria-label="Email Address" required>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="form-box">
                                    <input name="TxtPassword" type="password" class="form-control" autocomplete="off" id="second_field" placeholder="Password" aria-label="Password" required >
