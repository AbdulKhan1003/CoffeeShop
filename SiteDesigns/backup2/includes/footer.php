			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<a href="#" class="footer-logo"><img style="width:180px; height:140px;" src="images/small-logo-new.png" alt=""></a>
					</div>
					<div class="col-md-4 col-sm-6">
						<ul class="footer-contacts">
							<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo PhoneNo; ?></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="copyrights"><a href="#">Copyright &copy; 2023 by Abdul Hadi Khan <br>Developed <?php $date=2020; echo date('Y')-$date ?> Years ago.</a></div>
					</div>
				</div>
			</div>
		</div>
