	...
	<header class="top-nav" data-spy="affix" data-offset-top="34">
		<div class="container">
			<div class="row">
                ...
                <a href="index.php" class="main-logo"><img style="width: 269px; height: 200px;" src="images/main-logo-new.png" alt=""></a>
						...
						<div class="col-lg-8 col-md-12">
							<ul class="main-menu nav">
								...
								<li class="parent">
									...
									<ul class="sub-menu">
										<li><a href="product.php">Single item</a></li>
	...
	<section class="about-us">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="about-img"><img src="images/about-img-new.jpg" alt=""></div>
				</div>
			</div>
		</div>
	</section>
